...
- (void) initAudioPlayer
{
  ...
  @try
  {
    ...
    NSLog(@"Mic Input Chans: %i", (int)micInputFormat.channelCount);
    NSLog(@"Plugin Input SR: %i", (int)pluginInputFormat.sampleRate);
    NSLog(@"Plugin Input Chans: %i", (int)pluginInputFormat.channelCount);
#endif
    ...
    NSUInteger numOutputBuses = [avAudioUnit numberOfOutputs];
  ...
  {
    NSLog(@"An error occurred: %@", [exception reason]);
//    NSString *errorMessage = [NSString stringWithFormat:@"An error occurred in initAudioPlayer: %@", [exception reason]];
//    return errorMessage;
  }
}
...
- (void) channelRouteChanged
{
  ...
  @catch (NSException* exception)
  {
    NSLog(@"An error occurred in channelRouteChanged: %@", [exception reason]);
//    NSString *errorMessage = [NSString stringWithFormat:@"An error occurred in channelRouteChanged: %@", [exception reason]];
//    return errorMessage;
  }
}
